...
public class GameSweet : MonoBehaviour {
    ...
    private LearningGameManager.SweetsType type;
    public LearningGameManager.SweetsType Type
    {
        get
        {
            return type;
    ...
    [HideInInspector]
    public LearningGameManager gameManager;
    ...
    public void Init(int _x,int _y,LearningGameManager _gameManager,LearningGameManager.SweetsType _type)
    {
        x = _x;
        y = _y;
